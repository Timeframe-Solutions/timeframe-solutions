<template>
  ...
  >
    <div
      class="mx-auto max-w-[var(--tf-container-max)] px-[var(--tf-container-pad)] lg:px-[var(--tf-container-pad-lg)]"
    >
      <div class="flex h-[var(--tf-nav-height)] items-center justify-between">
        <!-- Logo -->
        <NuxtLink to="/" class="flex items-center gap-2 group">
          <div
            class="w-10 h-10 bg-tf-primary rounded-lg flex items-center justify-center text-white font-bold text-xl transition-transform group-hover:scale-105"
          >
            T
          </div>
          <span
            class="text-tf-text-primary font-display text-xl font-bold tracking-tight"
          >
