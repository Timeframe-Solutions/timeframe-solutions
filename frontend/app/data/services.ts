...
export const services: ServiceVertical[] = [
  {
    ...
    featureList: ['Property search & filtering', 'Image gallery with lightbox', 'WhatsApp lead capture', 'Google Maps', 'Local SEO meta tags']
  },
  {
    id: 'car-rental',
    icon: 'lucide:car',
    ...
    featureList: ['Fleet catalog', 'Dynamic price calculator', 'Booking form', 'WhatsApp fallback', 'Mobile-first design']
  },
  {
    id: 'healthcare',
    ...
    featureList: ['Appointment form', 'Doctor profiles', 'Service pages for local SEO', 'Google Maps', 'Blog (optional)']
  },
  {
    id: 'finance',
    ...
    featureList: ['Product / loan pages', 'Contact form', 'Branch locations', 'Management team section', 'Professional design system']
  },
  {
    id: 'retail',
    ...
    featureList: ['Product catalog', 'Search & filtering', 'Product gallery with zoom', 'Client-side cart', 'WhatsApp ordering']
  }
]
